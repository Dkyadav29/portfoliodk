  ...
  const projects = [
    {
      ...
      description: "Comprehensive mobile app with drawer navigation, tab navigation, and seamless user experience. Features include product catalog, shopping cart, user authentication, and offline support.",
    ...
    },
    {
      ...
      description: "Feature-rich social media application with real-time updates, user profiles, and interactive components. Includes chat functionality, post sharing, and notification system.",
      image: "https://readdy.ai/api/search-image?query=Social%20media%20mobile%20app%20interface%20with%20user%20profiles%2C%20chat%20messages%2C%20post%20feed%2C%20and%20notification%20system%2C%20modern%20app%20design%2C%20professional%20mobile%20UI%2C%20engaging%20social%20features%2C%20clean%20and%20intuitive%20layout%2C%20indigo%20and%20purple%20color%20scheme&width=600&height=400&seq=project-005&orientation=landscape",
    ...
    },
    {
      ...
      description: "Productivity app with advanced state management, offline capabilities, and intuitive user interface. Features task organization, project tracking, and team collaboration.",
      image: "https://readdy.ai/api/search-image?query=Task%20management%20mobile%20app%20interface%20showing%20project%20boards%2C%20task%20lists%2C%20calendar%20view%2C%20and%20team%20collaboration%20features%2C%20professional%20productivity%20app%20design%2C%20organized%20layout%2C%20modern%20UI%20elements%2C%20indigo%20and%20purple%20color%20scheme&width=600&height=400&seq=project-006&orientation=landscape",
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <div key={index} className="bg-white rounded-xl shadow-lg overflow-hidden border border-slate-200 hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {project.technologies.map((tech, techIndex) => (
                    <span key={techIndex} className="bg-gradient-to-r from-indigo-100 to-purple-100 text-indigo-800 px-3 py-1 rounded-full text-sm font-medium border border-indigo-200">
                      {tech}
                    </span>
                  ))}
                </div>
